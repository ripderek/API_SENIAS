...
const router = Router();
const { verificaUser, prueba_conexion, verificaUserGoogle, datos_formulario_token, login_register_participante, obtenerIPV4 } = require('../controllers/auth-controller')
